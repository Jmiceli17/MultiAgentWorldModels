...
PARSER.add('--max_frames', required=True, type=int, help='max number of frames/steps in episode')
PARSER.add('--min_frames', required=True, type=int, help='min number of frames/steps in episode')
PARSER.add('--max_trials', required=True, type=int, help='max number of trials')
PARSER.add('--num_agents', required=True, type=int, help='number of agents in the environment')
