...
Description:
  This is the original train.py file from the initial WorldModels implementation
  
  TODO: this file should be combined with the current train.py to work for all 3 
  evnironments
"""
